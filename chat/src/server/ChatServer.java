...
public class ChatServer extends UnicastRemoteObject implements IChatServer {
  ...
  public String sayHi(String ClientName) throws RemoteException {
        ...
        return "Welcome " + ClientName + " to the chat room";
    }
  ...
  @Override
    public void registerListener(String[] details) throws RemoteException {	
        ...
        System.out.println(details[0] + " joined the chat room");
  ...
  private void registerChatter(String[] details){		
        try{
            ...
            nextClient.messageFromServer("[Server]: Welcome " + details[0] + ", you are now free to chat.\n");
            
            sendToAll("[Server]: " + details[0] + " joined the group.\n");
    ...
    public void quitChat(String username) throws RemoteException{
        ...
        for(ConnectedClient c : connectedClients){
            if(c.getName().equals(username)){
                System.out.println(line + username + " left the chat room");
                System.out.println(new Date(System.currentTimeMillis()));
